...
// Remove Batteries
        ...
        removeRecipesByInputs(AUTOCLAVE_RECIPES, new ItemStack[]{ENERGIUM_DUST.getStackForm(9)}, new FluidStack[]{Water.getFluid(1000)});
        removeRecipesByInputs(AUTOCLAVE_RECIPES, new ItemStack[]{ENERGIUM_DUST.getStackForm(9)}, new FluidStack[]{DistilledWater.getFluid(1000)});
        removeRecipesByInputs(AUTOCLAVE_RECIPES, new ItemStack[]{ENERGIUM_DUST.getStackForm(9)}, new FluidStack[]{BlackSteel.getFluid(288)});
        removeRecipesByInputs(AUTOCLAVE_RECIPES, new ItemStack[]{ENERGIUM_DUST.getStackForm(9)}, new FluidStack[]{BlueSteel.getFluid(72)});

        removeRecipesByInputs(AUTOCLAVE_RECIPES, new ItemStack[]{OreDictUnifier.get(dust, Lapotron, 9)}, new FluidStack[]{Water.getFluid(1000)});
        removeRecipesByInputs(AUTOCLAVE_RECIPES, new ItemStack[]{OreDictUnifier.get(dust, Lapotron, 9)}, new FluidStack[]{DistilledWater.getFluid(1000)});
        removeRecipesByInputs(AUTOCLAVE_RECIPES, new ItemStack[]{OreDictUnifier.get(dust, Lapotron, 9)}, new FluidStack[]{BlackSteel.getFluid(288)});
        removeRecipesByInputs(AUTOCLAVE_RECIPES, new ItemStack[]{OreDictUnifier.get(dust, Lapotron, 9)}, new FluidStack[]{BlueSteel.getFluid(72)});
    }
}
