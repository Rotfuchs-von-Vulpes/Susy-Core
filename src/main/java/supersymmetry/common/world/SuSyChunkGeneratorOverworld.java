...
import supersymmetry.common.world.noise.OpenSimplexNoise;
import supersymmetry.common.world.noise.SimplexNoise;
...
public class SuSyChunkGeneratorOverworld implements IChunkGenerator {
    ...
    public SuSyChunkGeneratorOverworld(World world, long seed, String generatorOptions) {
        ...
        this.noise = new SimplexNoise(seed, 7, 2, 0.5);
    ...
    public void setBlocksInChunk(int x, int z, ChunkPrimer primer) {
        ...
        for (int i = 0; i < 16; i++) {
            for (int j = 0; j < 16; j++) {
                int stoneHeight = (int) Math.ceil(10 * this.noise.getNoised(x * 16 + i, z * 16 + j) + 63);
                int max = Math.max(stoneHeight, 63);
                for (int k = 0; k <= max; k++) {
                    if (k > stoneHeight) {
                        primer.setBlockState(i, k, j, oceanBlock);
                    } else {
