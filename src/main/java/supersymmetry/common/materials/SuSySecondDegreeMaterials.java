...
import static supersymmetry.api.unification.material.info.SuSyMaterialFlags.GENERATE_CATALYST_BED;
...
public class SuSySecondDegreeMaterials {
    ...
    public static void init() {
        ...
        AmmoniumNitrateSolution = new Material.Builder(13008, SuSyUtility.susyId("ammonium_nitrate_solution"))
                .liquid()
                .components(AmmoniumNitrate, 1, Water, 1)
                .colorAverage()
                .build();
        ...
        CalciumHydroxideSolution = new Material.Builder(13013, SuSyUtility.susyId("calcium_hydroxide_solution"))
                .liquid()
                .components(CalciumHydroxide, 1, Water, 1)
                .colorAverage()
                .build();
