...
public class SuSyFirstDegreeMaterials {
    private static Material generatePurifiedElement(Material material, int id, boolean generateLiquid, boolean generateIngot) {
        ...
        Material.Builder builder = new Material.Builder(id, SuSyUtility.susyId("high_purity_" + material.toString()))
                .dust()
                .iconSet(SHINY)
    ...
    public static void init() {
        ...
        NeodymiumAlloy = new Material.Builder(8400, SuSyUtility.susyId("neodymium_alloy"))
                ...
                .blast(1297, BlastProperty.GasTier.MID)
                .build();
        ...
        NickelHydrotalcite = new Material.Builder(8564, SuSyUtility.susyId("nickel_hydrotalcite"))
                .dust()
                .components(Nickel, 6, Aluminium, 2, Oxygen, 16, Hydrogen, 16, Chlorine, 1)
                .color(0x9fb833)
                .build();
